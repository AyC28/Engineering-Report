...
A watchdog timer is implemented to monitor the serial signal from the throttle, and will disable the motors if no valid signal has been received for 100ms. By default, the motors have a disabled state until valid throttle signal is applied. 
